...
class NotifyEmail extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
    ...
    public function sendEmail($customerdetails)
    {
        ...
        $product_url = $customerdetails['product_url'];
            $this->logger->debug('Product customer in stock Notify Stock Availability start');
        ...
        try {
            ...
            $this->inlineTranslation->resume();
            $this->logger->debug('Product customer in stock Notify Stock Availability end');
    }
}
